...
"""
    ...
    if template == "demo_short":
        ...
        print("\n下一步:")
        print("1. writer studio              # 打开 Studio 配置模型后写第一章")
        print("2. writer dante               # CLI 直接推进正文")
        return
    print("\n目录结构:")
    ...
    print("\n下一步:")
    print("1. writer goethe   # 先聊书名、冲突、人物与可写大纲")
    print("2. writer desk     # 查看资产就绪度与建议")
    print("3. writer dante    # 资产就绪后再持续写正文")
    print("4. writer studio   # 也可用网页端完成同样流程")
