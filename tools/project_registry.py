...
def default_registry_path() -> Path:
    return Path.home() / ".config" / "writer-assistant" / "recent_projects.yaml"


def is_framework_root(path: Path) -> bool:
    """Return whether *path* looks like the Writer Assistant source repository."""
    ...
    try:
        ...
        return False
    return 'name = "writer-assistant"' in head.lower()
